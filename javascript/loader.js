...
document.getElementById("ltotal").innerText = `Minted: ${mintInfo.totalMinted.toLocaleString()} NFTs`;
document.getElementById("ldate").innerText = `Mint is available ${collectionInfo.date}`;
